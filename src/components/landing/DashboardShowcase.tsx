  ...
  return (
    <div className="relative h-32 w-32">
      <svg viewBox="0 0 100 100" className="h-full w-full -rotate-90">
        ...
        <circle
          cx="50" cy="50" r={r}
          stroke="url(#hg)" strokeWidth="8" fill="none" strokeLinecap="round"
...
const offers = [
  { product: "Aapka Prime", rate: "10.4%", emi: "₹18,420", tag: "Best Match", tone: "text-emerald-400" },
  { product: "Aapka Express", rate: "10.9%", emi: "₹18,850", tag: "Fast Approval", tone: "text-sky-400" },
  { product: "Aapka Plus", rate: "11.2%", emi: "₹19,070", tag: "Low Fees", tone: "text-violet-400" },
];
  ...
  return (
    <section className="relative py-28">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading
          eyebrow="Product"
          title={<>A workspace as <span className="text-gradient-blue">smart as your money</span></>}
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-12">
              ...
              <div className="glass rounded-2xl p-5 lg:col-span-5">
                ...
                <ul className="mt-3 space-y-2">
                  {offers.map((o) => (
                    <li key={o.product} className="flex items-center justify-between rounded-xl bg-white/[0.03] p-3 ring-1 ring-white/5">
                      <div>
              ...
              <div className="glass rounded-2xl p-5 lg:col-span-3">
                ...
                <div className="mt-4 space-y-2 text-xs">
                  <div className="flex justify-between text-white/60"><span>Amount</span><span className="text-white">₹10,00,000</span></div>
                  <div className="flex justify-between text-white/60"><span>Tenure</span><span className="text-white">60 mo</span></div>
                  <div className="flex justify-between text-white/60"><span>Rate</span><span className="text-white">10.4%</span></div>
                </div>
              </div>
              ...
              <div className="glass rounded-2xl p-5 lg:col-span-7">
                ...
                <ul className="mt-3 space-y-3 text-sm">
                  {[
                    { t: "Eligibility check completed", s: "Profile matched", time: "2m ago", ok: true },
              ...
              <div className="glass rounded-2xl p-5 lg:col-span-5">
                <div className="flex items-center justify-between">
                  <p className="text-[11px] uppercase tracking-wider text-white/50">Repayment Trend</p>
                ...
                <svg viewBox="0 0 300 100" className="mt-3 h-24 w-full">
                  ...
                  <path d="M0,80 C40,60 60,70 90,50 C120,30 150,55 180,40 C210,28 240,35 300,15 L300,100 L0,100 Z" fill="url(#ar)" />
                  <path d="M0,80 C40,60 60,70 90,50 C120,30 150,55 180,40 C210,28 240,35 300,15" fill="none" stroke="#3B82F6" strokeWidth="2" />
                </svg>
